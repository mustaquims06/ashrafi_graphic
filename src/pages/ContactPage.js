      ...
      <div className="container mx-auto px-4">
        ...
        <ScrollAnimation animation="fade-in-up" delay={0.2}>
          <p className="text-xl text-center text-gray-600 dark:text-gray-300 mb-12 max-w-3xl mx-auto">
            Have a project in mind? Want to learn more about our services? Get in touch with us.
          </p>
        </ScrollAnimation>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent dark:bg-gray-800 dark:border-gray-600"
                  />
                </div>
                <div>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">info@ashrafigraphics.com</p>
                </div>
                <div>
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2 gold-text">Follow Us</h3>
